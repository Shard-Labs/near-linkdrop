...
const sender = 'linkdrop.dexterdev8.testnet'; // sender should be the implicit account
const receiver = 'linkdrop.dexterdev8.testnet'; // linkdrop contract
