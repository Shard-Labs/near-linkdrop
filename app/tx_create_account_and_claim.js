...
const sender = 'fall.poap.dexterdev8.testnet'; // sender should be the implicit account
const receiver = 'fall.poap.dexterdev8.testnet'; // linkdrop contract
...
// Sender private key is contained within QR code
// This private key must be from a Implicit Account
...
async function main() {
  ...
  const actions = [nearAPI.transactions.functionCall(
    ...
    {
      "new_account_id": "new_user.fall.poap.dexterdev8.testnet",
      "new_public_key": "Be8cWfAfKf2QnazamGssirhNXxeXTnVvGKwzh2BXBAxv"
    },
